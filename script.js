...
function generateRandomLowercase() {
    return String.fromCharCode(generateRandom(97, 123)); // 97 bhaneko lower case a ko ascii value ani 123 lower case z ko value
}

// Random uppercase Letter 
function generateRandomUppercase() {
    return String.fromCharCode(generateRandom(65, 91)); // 65 bhaneko  upper case ko a ani 91 z 
}
...
// passwordDisplay.value = "My Name is kulchandra";
...
async function copyContent() {
 ...
 // to make copy bhako span visible grna lai
...
generateBtn.addEventListener('click', () => {
    ...
    if (passwordLength < checkCount) {
        ...
        handleSlider(); // esko kam UI ko update grnu ho using password length 
    }
